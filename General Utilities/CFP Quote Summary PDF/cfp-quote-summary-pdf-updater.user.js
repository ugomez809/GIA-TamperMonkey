// ==UserScript==
// @name         CFP Quote Summary PDF Updater
// @namespace    local.cfp-quote-summary-pdf.updater
// @version      0.1
// @description  Loads and auto-updates the CFP Quote Summary PDF script from GitHub.
...
// @updateURL    https://raw.githubusercontent.com/ugomez809/GIA-TamperMonkey/main/General%20Utilities/CFP%20Quote%20Summary%20PDF/cfp-quote-summary-pdf-updater.user.js
// @downloadURL  https://raw.githubusercontent.com/ugomez809/GIA-TamperMonkey/main/General%20Utilities/CFP%20Quote%20Summary%20PDF/cfp-quote-summary-pdf-updater.user.js
// ==/UserScript==
...
(function () {
  ...
  const TARGET_ID = 'cfp-quote-summary-pdf';
  const TARGET_LABEL = 'CFP Quote Summary PDF';
  const TARGET_FILE = 'cfp-quote-summary-pdf.user.js';
  const BASE_URL = 'https://raw.githubusercontent.com/ugomez809/GIA-TamperMonkey/main/General%20Utilities/CFP%20Quote%20Summary%20PDF';
  ...
  async function getTargetBaseUrl() {
    try {
      ...
      latestBaseUrl = `https://raw.githubusercontent.com/ugomez809/GIA-TamperMonkey/${sha}/General%20Utilities/CFP%20Quote%20Summary%20PDF`;
  ...
  function applyOptionsFromUrl() {
    ...
    debugEnabled = isTruthy(url.searchParams.get('staffUpdaterDebug')) || isTruthy(url.searchParams.get('cfpQuoteSummaryUpdaterDebug'));
    forceRequested = isTruthy(url.searchParams.get('staffUpdaterForce')) || isTruthy(url.searchParams.get('cfpQuoteSummaryUpdaterForce'));
    clearRequested = isTruthy(url.searchParams.get('staffUpdaterClear')) || isTruthy(url.searchParams.get('cfpQuoteSummaryUpdaterClear'));
    ...
    url.searchParams.delete('cfpQuoteSummaryUpdaterDebug');
    url.searchParams.delete('cfpQuoteSummaryUpdaterForce');
    url.searchParams.delete('cfpQuoteSummaryUpdaterClear');
