// ==UserScript==
// @name         CFP Quick Quote PDF Updater
// @namespace    local.cfp-quick-quote-pdf.updater
// @version      0.1
// @description  Loads and auto-updates the CFP Quick Quote PDF script from GitHub.
...
// @updateURL    https://raw.githubusercontent.com/ugomez809/GIA-TamperMonkey/main/General%20Utilities/CFP%20Quick%20Quote%20PDF/cfp-quick-quote-pdf-updater.user.js
// @downloadURL  https://raw.githubusercontent.com/ugomez809/GIA-TamperMonkey/main/General%20Utilities/CFP%20Quick%20Quote%20PDF/cfp-quick-quote-pdf-updater.user.js
// ==/UserScript==
...
(function () {
  ...
  const TARGET_ID = 'cfp-quick-quote-pdf';
  const TARGET_LABEL = 'CFP Quick Quote PDF';
  const TARGET_FILE = 'cfp-quick-quote-pdf.user.js';
  const BASE_URL = 'https://raw.githubusercontent.com/ugomez809/GIA-TamperMonkey/main/General%20Utilities/CFP%20Quick%20Quote%20PDF';
  ...
  async function getTargetBaseUrl() {
    try {
      ...
      latestBaseUrl = `https://raw.githubusercontent.com/ugomez809/GIA-TamperMonkey/${sha}/General%20Utilities/CFP%20Quick%20Quote%20PDF`;
  ...
  function applyOptionsFromUrl() {
    ...
    debugEnabled = isTruthy(url.searchParams.get('staffUpdaterDebug')) || isTruthy(url.searchParams.get('cfpQuickQuoteUpdaterDebug'));
    forceRequested = isTruthy(url.searchParams.get('staffUpdaterForce')) || isTruthy(url.searchParams.get('cfpQuickQuoteUpdaterForce'));
    clearRequested = isTruthy(url.searchParams.get('staffUpdaterClear')) || isTruthy(url.searchParams.get('cfpQuickQuoteUpdaterClear'));
    ...
    url.searchParams.delete('cfpQuickQuoteUpdaterDebug');
    url.searchParams.delete('cfpQuickQuoteUpdaterForce');
    url.searchParams.delete('cfpQuickQuoteUpdaterClear');
