// ==UserScript==
// @name         LOCAL Ricochet Pickup / Hangup Counters Updater
// @namespace    local.ricochet-counters.updater
// @version      1.1.0
...
// @updateURL    https://raw.githubusercontent.com/ugomez809/GIA-TamperMonkey/main/Ricochet%20TM/Ricochet%20Pickup%20Hangup%20Counters/ricochet-counters-updater.user.js
// @downloadURL  https://raw.githubusercontent.com/ugomez809/GIA-TamperMonkey/main/Ricochet%20TM/Ricochet%20Pickup%20Hangup%20Counters/ricochet-counters-updater.user.js
// ==/UserScript==
...
(function () {
  ...
  const TARGET_ID = 'ricochet-counters';
  const TARGET_LABEL = 'Ricochet Pickup / Hangup Counters';
  const TARGET_FILE = 'ricochet-counters.user.js';
  const BASE_URL = 'https://raw.githubusercontent.com/ugomez809/GIA-TamperMonkey/main/Ricochet%20TM/Ricochet%20Pickup%20Hangup%20Counters';
  ...
  async function getTargetBaseUrl() {
    try {
      ...
      latestBaseUrl = `https://raw.githubusercontent.com/ugomez809/GIA-TamperMonkey/${sha}/Ricochet%20TM/Ricochet%20Pickup%20Hangup%20Counters`;
