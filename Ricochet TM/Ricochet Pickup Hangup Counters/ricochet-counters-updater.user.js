...
// @version      1.0.0
// @description  Checks Ricochet Pickup / Hangup Counters for GitHub updates.
// @author       JKira & Mr.G
...
(function () {
  ...
  const PANEL_ID = 'ricochet-counters-updater-panel';
  const STYLE_ID = 'ricochet-counters-updater-style';
  ...
  function renderPanel() {
    ...
    header.appendChild(createEl('strong', '', 'Counters Updater'));
